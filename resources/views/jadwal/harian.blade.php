                                ...
                                <td>
                                    ...
                                    <div class="d-flex align-items-center flex-wrap gap-2 mt-1">
                                        ...
                                        @if($session->ekstrakurikuler->no_telepon)
                                            ...
                                            @endphp
                                            <a href="https://wa.me/{{ $cleanPhone }}?text={{ $waText }}" target="_blank" rel="noopener" class="text-success d-inline-flex align-items-center" title="WhatsApp PJ: {{ $session->ekstrakurikuler->penanggung_jawab }}">
