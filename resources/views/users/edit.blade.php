                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control @error('tanggal_aktif') is-invalid @enderror" 
                                                   id="tanggal_aktif" 
                                                   name="tanggal_aktif" 
                                                   value="{{ old('tanggal_aktif', $user->tanggal_aktif ? $user->tanggal_aktif->format('Y-m-d') : '') }}">
                                            @error('tanggal_aktif')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control @error('tanggal_nonaktif') is-invalid @enderror" 
                                                   ...
                                                   value="{{ old('tanggal_nonaktif', $user->tanggal_nonaktif ? $user->tanggal_nonaktif->format('Y-m-d') : '') }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('alamat_domisili') is-invalid @enderror" 
                                                      ...
                                                      placeholder="Alamat lengkap...">{{ old('alamat_domisili', $user->instructorProfile->alamat_domisili ?? '') }}</textarea>
