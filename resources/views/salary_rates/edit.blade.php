            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3 border-bottom">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h5 class="card-title mb-0 fw-bold text-dark">Edit Tarif Master</h5>
                    </div>
                </div>
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('admin.salary-rates.update', $rate->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <select 
                                ...
                                required
                            >
                                <option value="junior" {{ old('level', $rate->level) === 'junior' ? 'selected' : '' }}>Junior</option>
                                <option value="madya" {{ old('level', $rate->level) === 'madya' ? 'selected' : '' }}>Madya</option>
                                <option value="senior" {{ old('level', $rate->level) === 'senior' ? 'selected' : '' }}>Senior</option>
                                <option value="expert" {{ old('level', $rate->level) === 'expert' ? 'selected' : '' }}>Expert</option>
                                <option value="master_trainer" {{ old('level', $rate->level) === 'master_trainer' ? 'selected' : '' }}>Master Trainer</option>
                            </select>
                            @error('level')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input 
                                    ...
                                    id="base_rate" 
                                    name="base_rate" 
                                    value="{{ old('base_rate', $rate->base_rate) }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <input 
                                ...
                                value="{{ old('product_category', $rate->product_category) }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input 
                                    ...
                                    id="product_bonus" 
                                    name="product_bonus" 
                                    value="{{ old('product_bonus', $rate->product_bonus) }}" 
                                    placeholder="0"
                                    required
                                >
                            </div>
                        ...
                        <div class="d-grid mt-4">
                            <button type="submit" class="btn btn-primary py-2">
                                <i class="bi bi-save me-1"></i> Perbarui Tarif Master
                            </button>
                        </div>
                    </form>
                </div>
