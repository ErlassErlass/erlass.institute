            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3 border-bottom">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h5 class="card-title mb-0 fw-bold text-dark">Buat Surat Pesanan (SP) Baru</h5>
                    </div>
                </div>
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="{{ route('orders-sp.store') }}" id="sp-form">
                        @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input 
                                        ...
                                        name="nomor_sp" 
                                        value="{{ old('nomor_sp') }}" 
                                        placeholder="CONTOH: 001/SP/ERLASS/VI/2026"
                                        required
                                    >
                                    @error('nomor_sp')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input 
                                        ...
                                        id="tanggal_sp" 
                                        name="tanggal_sp" 
                                        value="{{ old('tanggal_sp', date('Y-m-d')) }}" 
                                        required
                                    >
                                    @error('tanggal_sp')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="mb-3">
                                    ...
                                    >
                                        ...
                                        @foreach($salesmen as $sm)
                                            <option value="{{ $sm->id }}" {{ old('salesman_id') == $sm->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input 
                                        ...
                                        value="{{ old('jumlah_peserta_estimasi', 0) }}" 
                                        min="0"
                                        required
                                    >
                                ...
                                <div class="mb-3">
                                    ...
                                    <input 
                                        ...
                                        value="{{ old('lokasi_pembelajaran', 'Sekolah') }}" 
                                        required
                                    >
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input 
                                            ...
                                            value="{{ old('tanggal_mulai_rencana') }}" 
                                            required
                                        >
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="catatan_khusus" id="catatan_khusus" class="form-control" rows="2" placeholder="Catatan opsional mengenai kesepakatan, jadwal, atau asisten...">{{ old('catatan_khusus') }}</textarea>
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            <a href="{{ route('orders-sp.index') }}" class="btn btn-outline-secondary px-4">Batal</a>
                            <button type="submit" class="btn btn-primary px-5">
                                <i class="bi bi-save me-1"></i> Simpan Draft SP
                            </button>
                        </div>
                    </form>
                </div>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.remove-product-btn', function() {
        ...
        if ($('#products-table tbody tr').length === 1) { // Only the #empty-row remains hidden
            $('#empty-row').show();
        }
    });
});
