...
class EkstrakurikulerControllerTest extends TestCase
{
    ...
    /** @test */
    public function create_step_1_includes_kotaOptions_variable()
    {
    ...
    /** @test */
    public function step1_blade_uses_kotaOptions_instead_of_cities()
    {
        $response = $this->actingAs($this->user)->get(route('ekstrakurikuler.create'));
    ...
    /** @test */
    public function all_controller_methods_pass_kotaOptions_consistently()
    {
        // Test index method
