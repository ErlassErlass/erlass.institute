...
| **admin_sistem** | Admin Sistem | Administrator Teknis & Operasional Utama. | **High**. Akses penuh ke operasional, Data Master, Kompensasi & Payroll, serta Penjadwalan. Pemegang otorisasi utama payroll & master CRUD: **Adinda Wardania** (`adinda.wardania@erlass.institute`), **Cornelis Banu** (`cornelis.banu@erlass.institute`), & **Ahmad Yusril Firdaus** (`ahmad.firdaus@erlass.institute`). |
